          ...
          <nav className="mx-auto max-w-7xl px-4 py-4">
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="block rounded-lg px-4 py-3 text-base font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-brand-950"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <div className="mt-4 border-t border-gray-100 pt-4">
              <a
                ...
                className="flex items-center gap-2 rounded-lg bg-brand-950 px-4 py-3 text-center text-base font-semibold text-white transition-colors hover:bg-brand-800"
              >
